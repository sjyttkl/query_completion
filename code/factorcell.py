...
class FactorCell(tf.compat.v1.nn.rnn_cell.RNNCell):  # tf.nn.rnn_cell.RNNCell
    ...
    def __init__(self, num_units, embedding_size, context_embed,
        ...
        with tf.variable_scope('factor_cell'):
            ...
            if self.lowrank_adaptation:
                context_embed_size = context_embed.get_shape()[1]  # .value # user_embed_size
